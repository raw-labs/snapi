...
object HttpByteStreamClient {
  ...
  private val HTTP_CONNECT_TIMEOUT = "com.rawlabs.utils.sources.bytestream.http.connect-timeout"
  private val HTTP_READ_TIMEOUT = "com.rawlabs.utils.sources.bytestream.http.read-timeout"
