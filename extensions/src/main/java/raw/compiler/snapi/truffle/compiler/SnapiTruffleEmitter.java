...
public class SnapiTruffleEmitter extends TruffleEmitter {
    ...
    return switch (ld) {
      case LetBind lb -> {
        ...
        int slot = switch (rql2Type) {
          case Rql2UndefinedType ignored -> getFrameDescriptorBuilder().addSlot(FrameSlotKind.Object, getIdnName(entity), null);
          case ExpType ignored ->  getFrameDescriptorBuilder().addSlot(FrameSlotKind.Object, getIdnName(entity), null);
          case Rql2ByteType ignored ->  getFrameDescriptorBuilder().addSlot(FrameSlotKind.Byte, getIdnName(entity), null);
          case Rql2ShortType ignored ->  getFrameDescriptorBuilder().addSlot(FrameSlotKind.Int, getIdnName(entity), null);
          case Rql2IntType ignored ->  getFrameDescriptorBuilder().addSlot(FrameSlotKind.Int, getIdnName(entity), null);
          case Rql2LongType ignored ->  getFrameDescriptorBuilder().addSlot(FrameSlotKind.Long, getIdnName(entity), null);
          case Rql2FloatType ignored ->  getFrameDescriptorBuilder().addSlot(FrameSlotKind.Float, getIdnName(entity), null);
          case Rql2DoubleType ignored ->  getFrameDescriptorBuilder().addSlot(FrameSlotKind.Double, getIdnName(entity), null);
          case Rql2DecimalType ignored ->  getFrameDescriptorBuilder().addSlot(FrameSlotKind.Object, getIdnName(entity), null);
          case Rql2BoolType ignored ->  getFrameDescriptorBuilder().addSlot(FrameSlotKind.Boolean, getIdnName(entity), null);
          case Rql2StringType ignored ->  getFrameDescriptorBuilder().addSlot(FrameSlotKind.Object, getIdnName(entity), null);
          case Rql2DateType ignored ->  getFrameDescriptorBuilder().addSlot(FrameSlotKind.Object, getIdnName(entity), null);
          case Rql2TimeType ignored ->  getFrameDescriptorBuilder().addSlot(FrameSlotKind.Object, getIdnName(entity), null);
          case Rql2TimestampType ignored ->  getFrameDescriptorBuilder().addSlot(FrameSlotKind.Object, getIdnName(entity), null);
          case Rql2IntervalType ignored ->  getFrameDescriptorBuilder().addSlot(FrameSlotKind.Object, getIdnName(entity), null);
          case Rql2BinaryType ignored ->  getFrameDescriptorBuilder().addSlot(FrameSlotKind.Object, getIdnName(entity), null);
          case Rql2IterableType ignored ->  getFrameDescriptorBuilder().addSlot(FrameSlotKind.Object, getIdnName(entity), null);
          case Rql2ListType ignored ->  getFrameDescriptorBuilder().addSlot(FrameSlotKind.Object, getIdnName(entity), null);
          case FunType ignored ->  getFrameDescriptorBuilder().addSlot(FrameSlotKind.Object, getIdnName(entity), null);
          case Rql2RecordType ignored ->  getFrameDescriptorBuilder().addSlot(FrameSlotKind.Object, getIdnName(entity), null);
          case Rql2LocationType ignored ->  getFrameDescriptorBuilder().addSlot(FrameSlotKind.Object, getIdnName(entity), null);
          case PackageType ignored ->  getFrameDescriptorBuilder().addSlot(FrameSlotKind.Object, getIdnName(entity), null);
          case PackageEntryType ignored ->  getFrameDescriptorBuilder().addSlot(FrameSlotKind.Object, getIdnName(entity), null);
  ...
  protected ExpressionNode recurseExp(Exp in) {
    return switch (in) {
      ...
      case IdnExp ie -> switch (analyzer.entity().apply(ie.idn())) {
        ...
        case FunParamEntity f -> {
          ...
          if (depth == 0) {
            ...
            scala.collection.immutable.Vector<SourceNode> fp = p.apply(f.f());
      ...
      case IfThenElse ite -> new IfThenElseNode(recurseExp(ite.e1()), recurseExp(ite.e2()), recurseExp(ite.e2()));
