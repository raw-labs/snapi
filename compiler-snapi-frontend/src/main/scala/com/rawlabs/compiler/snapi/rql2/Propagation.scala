...
import com.rawlabs.compiler.snapi.rql2.api.{Arg, Rql2Value, ValueArg}
import com.rawlabs.compiler.snapi.rql2.builtin._
...
class Propagation(protected val parent: Phase[SourceProgram], protected val phaseName: String)(
    protected val baseProgramContext: com.rawlabs.compiler.snapi.base.ProgramContext
