...
package com.rawlabs.snapi.frontend.snapi.errors

import com.rawlabs.snapi.frontend.base.errors.{MissingSecretWarning, UnexpectedType}
import com.rawlabs.snapi.frontend.base.source.BaseNode
import com.rawlabs.snapi.frontend.{base, snapi}
import com.rawlabs.snapi.frontend.snapi.source.{ExpectedProjType, PackageType}

trait ErrorsPrettyPrinter extends base.errors.ErrorsPrettyPrinter with snapi.source.SourcePrettyPrinter {
