...
import com.rawlabs.snapi.frontend.snapi.errors.ErrorsPrettyPrinter
  ...
  def hover(source: String, environment: ProgramEnvironment, position: Pos): HoverResponse = {
    ...
    val res = nodes
      ...
      .collectFirst {
        ...
        // for debugging
        //        case snapiNode: SnapiNode => snapiNode
      }
...
object LspAnalyzer {
  private val existingTypes = Array(
    "byte",
    "short",
    "int",
    "long",
