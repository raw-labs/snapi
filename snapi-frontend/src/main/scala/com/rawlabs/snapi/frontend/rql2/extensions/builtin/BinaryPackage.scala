...
import com.rawlabs.snapi.frontend.rql2.extensions.{PackageExtension, ShortEntryExtension}
...
object BinaryPackageBuilder {
  ...
  object FromString {
    def apply(e: Exp): Exp = {
      FunApp(Proj(PackageIdnExp("Binary"), "FromString"), Vector(FunAppArg(e, None)))
    }
  }
