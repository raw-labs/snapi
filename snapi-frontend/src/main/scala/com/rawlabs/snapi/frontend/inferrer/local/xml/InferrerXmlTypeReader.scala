...
import com.rawlabs.snapi.frontend.inferrer.local.{LocalInferrerException, TextTypeInferrer}
import com.rawlabs.snapi.frontend.inferrer.api._

import java.io.{Reader, StringReader}
import javax.xml.stream.{XMLInputFactory, XMLStreamConstants}
import scala.collection.mutable
import com.rawlabs.snapi.frontend.inferrer.local.xml.InferrerXmlTypeReader._
