...
//
//object SnowflakeTableLocationBuilder {
...
//
//  import SnowflakeTableLocationBuilder._
//
...
//    val List(host, dbName, schema, table) = groups
...
//    new SnowflakeTableLocation(db, dbName, schema, table)
//  }
//
//}
