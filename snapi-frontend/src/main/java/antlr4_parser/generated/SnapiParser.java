...
public class SnapiParser extends Parser {
	...
	public static final int
		...
		FALSE_TOKEN=63, STRING=64, TRIPPLE_STRING=65, IDENT=66, NON_ESC_IDENTIFIER=67, 
	...
	public static final int
		...
		RULE_compare_tokens = 31, RULE_bool_const = 32;
	...
	public final Fun_arContext fun_ar() throws RecognitionException {
		...
		try {
			...
			_errHandler.sync(this);
			_la = _input.LA(1);
			if ((((_la) & ~0x3f) == 0 && ((1L << _la) & -2251519292191271676L) != 0) || ((((_la - 64)) & ~0x3f) == 0 && ((1L << (_la - 64)) & 7L) != 0)) {
				{
				setState(148);
				fun_args();
				}
	...
	public static class OrTypeFunTypeContext extends TypeContext {
		...
		public OrTypeFunTypeContext(TypeContext ctx) { copyFrom(ctx); }
		@Override
		public void enterRule(ParseTreeListener listener) {
