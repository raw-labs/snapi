...
public class SnapiParser extends Parser {
  ...
  public static final int RULE_prog = 0,
      ...
      RULE_let_decl = 21,
      RULE_let_bind = 22,
      RULE_if_then_else = 23,
      RULE_lists = 24,
      RULE_lists_element = 25,
      RULE_records = 26,
      RULE_record_elements = 27,
      RULE_record_element = 28,
      RULE_number = 29,
  ...
  public static class MethodDecContext extends Method_decContext {
    public TerminalNode IDENT() {
      return getToken(SnapiParser.IDENT, 0);
    }
  ...
  public static class FunProtoWithTypeContext extends Fun_protoContext {
    ...
    public FunProtoWithTypeContext(Fun_protoContext ctx) {
      copyFrom(ctx);
    }
    ...
    public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
      if (visitor instanceof SnapiVisitor)
        return ((SnapiVisitor<? extends T>) visitor).visitFunProtoWithType(this);
      else return visitor.visitChildren(this);
    }
  }
  ...
  public static class FunProtoWithoutTypeContext extends Fun_protoContext {
    ...
    public FunProtoWithoutTypeContext(Fun_protoContext ctx) {
      copyFrom(ctx);
    }
    ...
    public void enterRule(ParseTreeListener listener) {
      if (listener instanceof SnapiListener)
        ((SnapiListener) listener).enterFunProtoWithoutType(this);
    }

    @Override
    public void exitRule(ParseTreeListener listener) {
      if (listener instanceof SnapiListener)
        ((SnapiListener) listener).exitFunProtoWithoutType(this);
    }

    @Override
    public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
      if (visitor instanceof SnapiVisitor)
        return ((SnapiVisitor<? extends T>) visitor).visitFunProtoWithoutType(this);
      else return visitor.visitChildren(this);
    }
  }
  ...
  public final Fun_arContext fun_ar() throws RecognitionException {
    ...
    try {
      enterOuterAlt(_localctx, 1);
      {
        ...
        _errHandler.sync(this);
        _la = _input.LA(1);
        if ((((_la) & ~0x3f) == 0 && ((1L << _la) & -2251519292191271676L) != 0)
            || ((((_la - 64)) & ~0x3f) == 0 && ((1L << (_la - 64)) & 7L) != 0)) {
          {
            setState(148);
            fun_args();
          }
  ...
  public final Bool_constContext bool_const() throws RecognitionException {
    ...
    enterRule(_localctx, 64, RULE_bool_const);
    int _la;
    try {
      enterOuterAlt(_localctx, 1);
      {
