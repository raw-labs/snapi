...
public class SnapiParser extends Parser {
	...
	public static final int
		...
		RULE_record_element = 29, RULE_signed_number = 30, RULE_number = 31, RULE_primitive_types = 32, 
		RULE_string_literal = 33, RULE_triple_string_literal = 34, RULE_compare_tokens = 35, 
		RULE_bool_const = 36, RULE_ident = 37, RULE_package_idn_exp = 38, RULE_nullable_tryable = 39;
	private static String[] makeRuleNames() {
		return new String[] {
			...
			"lists_element", "records", "record_elements", "record_element", "signed_number", 
			"number", "primitive_types", "string_literal", "triple_string_literal", 
			"compare_tokens", "bool_const", "ident", "package_idn_exp", "nullable_tryable"
		};
	}
