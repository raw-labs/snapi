...
public class SnapiParser extends Parser {
	...
	public static final int
		...
		NULL_TOKEN=40, BYTE=41, SHORT=42, INTEGER=43, LONG=44, FLOAT=45, DOUBLE=46, 
		...
		MOD_TOKEN=58, AND_TOKEN=59, OR_TOKEN=60, NOT_TOKEN=61, TRUE_TOKEN=62, 
		FALSE_TOKEN=63, STRING=64, TRIPPLE_STRING=65, NON_ESC_IDENTIFIER=66, ESC_IDENTIFIER=67, 
		WS=68, LINE_COMMENT=69;
	public static final int
	...
	private static String[] makeSymbolicNames() {
		return new String[] {
			...
			"NOT_TOKEN", "TRUE_TOKEN", "FALSE_TOKEN", "STRING", "TRIPPLE_STRING", 
			"NON_ESC_IDENTIFIER", "ESC_IDENTIFIER", "WS", "LINE_COMMENT"
		};
	}
	...
	public final Fun_arContext fun_ar() throws RecognitionException {
		...
		try {
			...
			_errHandler.sync(this);
			_la = _input.LA(1);
			if ((((_la) & ~0x3f) == 0 && ((1L << _la) & -2251519292191271678L) != 0) || ((((_la - 64)) & ~0x3f) == 0 && ((1L << (_la - 64)) & 15L) != 0)) {
				{
				setState(138);
				fun_args();
				}
	...
	public static class Fun_proto_lambdaContext extends ParserRuleContext {
		...
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof SnapiVisitor ) return ((SnapiVisitor<? extends T>)visitor).visitFun_proto_lambda(this);
			else return visitor.visitChildren(this);
		}
	}
	...
	public static class OrTypeFunTypeContext extends TipeContext {
		...
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof SnapiVisitor ) return ((SnapiVisitor<? extends T>)visitor).visitOrTypeFunType(this);
			else return visitor.visitChildren(this);
		}
	}
	@SuppressWarnings("CheckReturnValue")
