...
object BuildSettings {
  lazy val licenseHeader = """Copyright 2023 RAW Labs S.A.
  ...
  lazy val snapiFrontendCompileSettings = compileSettings ++ Seq(
    scalacOptions += "-Xlint:-stars-align,_",
    compileOrder := CompileOrder.ScalaThenJava,
  )

  lazy val snapiTruffleCompileSettings = compileSettings ++ Seq(
    scalacOptions += "-Xlint:-stars-align,_",
