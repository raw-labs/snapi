...
object S3FileSystem {
  private val CONNECT_TIMEOUT = "com.rawlabs.utils.sources.s3.connect-timeout"
  private val READ_TIMEOUT = "com.rawlabs.utils.sources.s3.read-timeout"
  private val MAX_CONNECTIONS = "com.rawlabs.utils.sources.s3.max-connections"
  private val DEFAULT_REGION = "com.rawlabs.utils.sources.s3.default-region"
}
