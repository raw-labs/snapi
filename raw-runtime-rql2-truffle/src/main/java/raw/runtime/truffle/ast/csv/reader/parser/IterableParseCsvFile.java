...
public class IterableParseCsvFile extends ExpressionNode {
    ...
    private OptionLibrary options = OptionLibrary.getFactory().getUncached();

    public IterableParseCsvFile(ExpressionNode location,
                                ExpressionNode encodingExp, ExpressionNode skipExp, ExpressionNode delimiterExp, ExpressionNode quoteExp, ProgramExpressionNode columnParser,
