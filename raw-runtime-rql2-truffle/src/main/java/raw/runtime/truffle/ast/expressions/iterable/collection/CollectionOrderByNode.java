...
public class CollectionOrderByNode extends ExpressionNode {
    ...
    public CollectionOrderByNode(ExpressionNode input, ExpressionNode[] keyFuns, ExpressionNode[] orderings, Rql2TypeWithProperties[] keyTypes, Rql2TypeWithProperties valueType) {
        this.input = input;
    ...
    public Object executeGeneric(VirtualFrame frame) {
        ...
        return new OrderByCollection(iterable, keyFunctions, orders, keyTypes, valueType, RawLanguage.get(this), RawContext.get(this).getRuntimeContext());
    }
