    ...
    protected Object doDescribe(
        ...
        try {
            ...
            if (descriptor instanceof ExcelInputFormatDescriptor) {
                ExcelInputFormatDescriptor excelDescriptor =
                        (ExcelInputFormatDescriptor) descriptor;
                format = "excel";
                comment = "";
                ...
                comment =
                        String.format(
                                        ...
                                        textInputQueryDescriptor.encoding(),
                                        textInputQueryDescriptor.confidence())
                                + "%)";
                if (textInputQueryDescriptor.format() instanceof CsvInputFormatDescriptor) {
                    ...
                    properties.put(
                            ...
                            nans.stream()
                                    ...
                                    .collect(Collectors.joining(",", "[", "]")));
                    properties.put(
                            "multiLine_fields", String.valueOf(csvDescriptor.multiLineFields()));
                ...
                } else if (textInputQueryDescriptor.format()
                        instanceof HjsonInputFormatDescriptor) {
                    ...
                    sampled = xmlDescriptor.sampled();
                        ...
                        instanceof LinesInputFormatDescriptor) {
            ...
            for (int i = 0; i < keyList.size(); i++) {
                ...
                if (properties.containsKey(keyList.get(i))) {
                    records.writeMember(
                            rec, "value", new StringOption(properties.get(keyList.get(i))));
                } else {
            ...
            if (flatten instanceof Rql2RecordType) {
                ...
                for (int i = 0; i < rql2RecordType.atts().length(); i++) {
                    ...
                    records.writeMember(
                            column,
                            "col_name",
                            new StringOption(rql2RecordType.atts().apply(i).idn()));
