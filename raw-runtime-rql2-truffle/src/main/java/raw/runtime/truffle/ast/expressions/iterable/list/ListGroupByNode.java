...
public abstract class ListGroupByNode extends ExpressionNode {
    ...
    protected Object doGroup(Object input, Closure keyFun,
        ...
        OffHeapListGroupByKey map = new OffHeapListGroupByKey(this::compareKey, getKeyType(), getRowType(), RawLanguage.get(this), context);
