...
public abstract class LocationLlNode extends ExpressionNode {
    @Specialization
    protected Object doLl(LocationObject locationObject, @CachedLibrary(limit = "5") InteropLibrary records) {
        try {
            ...
            IndexedSeq<Tuple2<FileSystemLocation, FileSystemMetadata>> values = fs.lsWithMetadata().toIndexedSeq();
