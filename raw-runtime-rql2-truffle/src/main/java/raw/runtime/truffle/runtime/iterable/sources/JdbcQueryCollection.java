...
public class JdbcQueryCollection {
    ...
    public JdbcQueryCollection(LocationObject dbLocation, String query, RuntimeContext context, DirectCallNode rowParser, JdbcExceptionHandler exceptionHandler) {
    ...
    @ExportMessage
    Object getGenerator() {
        return new CollectionAbstractGenerator(new JdbcQueryComputeNext(dbLocation, query, context, rowParser, exceptionHandler));
    }
}
