...
public final class OrderByCollection {
    ...
    public OrderByCollection(Object iterable, Closure[] keyFunctions, int[] keyOrderings,
                             Rql2TypeWithProperties[] keyTypes, Rql2TypeWithProperties rowType,
    ...
    private int compareKeys(Object[] keys1, Object[] keys2) {
        ...
        // If keys are different, the comparison result is multiplied by the 'order' of the key to reflect the "ASC/DESC".
    ...
    @ExportMessage
    Object getGenerator(@CachedLibrary(limit = "5") IterableLibrary iterables,
                        @CachedLibrary(limit = "5") GeneratorLibrary generators) {
        Object generator = iterables.getGenerator(parentIterable);
        OffHeapGroupByKeys groupByKeys = new OffHeapGroupByKeys(this::compareKeys, keyTypes, rowType, language, context);
        try {
