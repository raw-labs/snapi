...
// (az) this one is to be deleted and anywhere it is used shuld be replaced with the TryableNullableHandler
@ExportLibrary(NullableTryableLibrary.class)
public class RuntimeNullableTryableHandler {
    @ExportMessage
    public Object unboxUnsafe(Object maybeOptionTryable,
    ...
    @ExportMessage
    public Object unbox(Object maybeOptionTryable,
                        @CachedLibrary("this") NullableTryableLibrary nullableTryables,
                        @CachedLibrary(limit = "1") TryableLibrary triables) {
        if (maybeOptionTryable != null) {
            if (triables.isTryable(maybeOptionTryable)) {
    ...
    @ExportMessage
    Object unboxOption(Object maybeOptionTryable, @CachedLibrary(limit = "1") OptionLibrary options) {
        if (maybeOptionTryable != null) {
    ...
    @ExportMessage
    Boolean handleOptionTriablePredicate(Object maybeOptionTryable, Boolean defaultValue,
                                         @CachedLibrary("this") NullableTryableLibrary nullableTryables,
        ...
        if (maybeOptionTryable != null) {
            if (tryables.isTryable(maybeOptionTryable)) {
                ...
                return nullableTryables.handleOptionPredicate(this, maybeOptionTryable, defaultValue);
            }
        } else {
            return defaultValue;
        }
    ...
    @ExportMessage
    Object getOrElse(Object value, Object defaultValue,
                     @CachedLibrary(limit = "1") TryableLibrary tryables,
    ...
    @ExportMessage
    Boolean handleOptionPredicate(Object value, Boolean defaultValue,
    ...
    static class BoxOption {
        ...
        static Object doOption(RuntimeNullableTryableHandler nullableTryables, Object value, @CachedLibrary("value") OptionLibrary options) {
            return value;
        }
    ...
    static class BoxTryable {
        ...
        static Object doTryable(RuntimeNullableTryableHandler nullableTryables, Object value, @CachedLibrary("value") TryableLibrary triables) {
            return value;
        }
