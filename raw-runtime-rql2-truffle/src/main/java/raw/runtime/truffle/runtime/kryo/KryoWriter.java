...
public final class KryoWriter {
    ...
    static class Write {
        ...
        static void doByte(
                KryoWriter receiver, Output output, Rql2TypeWithProperties type, byte o) {
            output.writeByte(o);
        }

        @Specialization(guards = {"isShortKind(type)"})
        static void doShort(
                KryoWriter receiver, Output output, Rql2TypeWithProperties type, short o) {
            output.writeShort(o);
        }
        ...
        static void doLong(
                KryoWriter receiver, Output output, Rql2TypeWithProperties type, long o) {
            output.writeLong(o);
        }

        @Specialization(guards = {"isFloatKind(type)"})
        static void doFloat(
                KryoWriter receiver, Output output, Rql2TypeWithProperties type, float o) {
            output.writeFloat(o);
        }
        ...
        @Specialization
        static void doBool(
                KryoWriter receiver, Output output, Rql2TypeWithProperties type, boolean o) {
