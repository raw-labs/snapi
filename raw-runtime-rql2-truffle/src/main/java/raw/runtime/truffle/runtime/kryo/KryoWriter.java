...
public final class KryoWriter {
    ...
    static class Write {
        ...
        static void doTryable(KryoWriter receiver, Output output, Rql2TypeWithProperties type,
            ...
            if (isSuccess) {
                ...
                kryo.write(receiver, output, (Rql2TypeWithProperties) type.cloneAndRemoveProp(isTryable), value);
            } else {
        ...
        static void doNullable(KryoWriter receiver, Output output, Rql2TypeWithProperties type, Object option,
            ...
            if (isDefined) {
                ...
                kryo.write(receiver, output, (Rql2TypeWithProperties) type.cloneAndRemoveProp(isNullable), value);
            }
        }

        @Specialization(guards = {"isListKind(type)"}, limit = "1")
        static void doList(KryoWriter receiver, Output output, Rql2TypeWithProperties type, Object o,
                           @CachedLibrary("receiver") KryoWriterLibrary writerLibrary,
                           @CachedLibrary("o") ListLibrary lists) {
            output.writeInt((int) lists.size(o));
            Rql2TypeWithProperties elementType = (Rql2TypeWithProperties)((Rql2ListType)type).innerType();
        ...
        static void doIterable(KryoWriter receiver, Output output, Rql2TypeWithProperties type, Object o,
                               @CachedLibrary("receiver") KryoWriterLibrary writerLibrary,
                               @CachedLibrary("o") IterableLibrary iterators,
                               @CachedLibrary(limit = "2") GeneratorLibrary generators
        ) {
            Rql2TypeWithProperties elementType = (Rql2TypeWithProperties) ((Rql2IterableType) type).innerType();
        ...
        static void doRecord(KryoWriter receiver, Output output, Rql2RecordType type, Object o,
                             @CachedLibrary("receiver") KryoWriterLibrary writerLibrary,
        ...
        static void doDate(KryoWriter receiver, Output output, Rql2TypeWithProperties type, DateObject o) {
        ...
        static void doTime(KryoWriter receiver, Output output, Rql2TypeWithProperties type, TimeObject o) {
        ...
        static void doTimestamp(KryoWriter receiver, Output output, Rql2TypeWithProperties type, TimestampObject o) {
        ...
        static void doInterval(KryoWriter receiver, Output output, Rql2TypeWithProperties type, IntervalObject o) {
        ...
        @Specialization
        static void doDouble(KryoWriter receiver, Output output, Rql2TypeWithProperties type, double o) {
            output.writeDouble(o);
        }

        @Specialization
        static void doDecimal(KryoWriter receiver, Output output, Rql2TypeWithProperties type, BigDecimal o) {
            output.writeString(o.toString());
        }

        @Specialization
        static void doString(KryoWriter receiver, Output output, Rql2TypeWithProperties type, String o) {
