...
public class MinAggregator {
    ...
    public Object merge(Object current, Object next, @CachedLibrary("this.compareOperator") OperatorLibrary operators, @CachedLibrary(limit = "3") OptionLibrary options) {
