...
public abstract class NullableTryableLibrary extends Library {
    ...
    static final LibraryFactory<NullableTryableLibrary> FACTORY = LibraryFactory.resolve(NullableTryableLibrary.class);
    ...
    public abstract Boolean handleOptionTriablePredicate(Object receiver, Object maybeOptionTryable, Boolean defaultValue);

    protected abstract Boolean handleOptionPredicate(Object receiver, Object maybeOptionTryable, Boolean defaultValue);

    public abstract Object getOrElse(Object receiver, Object maybeOptionTryable, Object defaultValue);
