...
public class OffHeapDistinct {
    private final TreeSet<Object> index; // in-memory map that's used as long as the data fits in memory.
    ...
    private int binarySize; // estimated size of currently memory held objects (when reaching blockSize, spill to disk).
    ...
    public OffHeapDistinct(Comparator<Object> itemCmp, Rql2TypeWithProperties vType, RawLanguage rl,
