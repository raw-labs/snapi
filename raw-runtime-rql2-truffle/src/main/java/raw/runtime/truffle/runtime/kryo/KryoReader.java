    ...
    static class Read {
            ...
            if (isSuccess) {
                Rql2TypeWithProperties successType =
                        (Rql2TypeWithProperties)
                                t.cloneAndRemoveProp(new Rql2IsTryableTypeProperty());
        ...
        static Object doNullable(
            ...
            if (isDefined) {
                Rql2TypeWithProperties innerType =
                        (Rql2TypeWithProperties)
                                t.cloneAndRemoveProp(new Rql2IsNullableTypeProperty());
        ...
        static RecordObject doRecord(
            ...
            recordType
                    ...
                    .forall(
                            att -> {
                                Rql2TypeWithProperties attType =
        ...
        static IntervalObject doInterval(
                KryoReader receiver, Input input, Rql2TypeWithProperties t) {
        ...
        static TimeObject doTime(KryoReader receiver, Input input, Rql2TypeWithProperties t) {
            ...
            return new TimeObject(
                    LocalTime.of(
                            hours, minutes, seconds, (int) TimeUnit.MILLISECONDS.toNanos(millis)));
        }
