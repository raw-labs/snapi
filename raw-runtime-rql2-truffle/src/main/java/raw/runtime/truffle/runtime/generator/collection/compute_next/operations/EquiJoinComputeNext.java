...
public class EquiJoinComputeNext {
    ...
    void init(
            ...
            @Cached.Shared("sharedGenerators") @CachedLibrary(limit = "5")
        ...
        OffHeapEquiJoinGroupByKey leftMap =
                new OffHeapEquiJoinGroupByKey(
                        this::compareKey, keyType, leftRowType, language, context);
        ...
        OffHeapEquiJoinGroupByKey rightMap =
                new OffHeapEquiJoinGroupByKey(
                        this::compareKey, keyType, rightRowType, language, context);
