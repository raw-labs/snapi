    ...
    cred.provider match {
      ...
      case _ =>
        val cli = cred.provider match {
          case raw.creds.OAuth2Provider.Dropbox => new DropboxOAuth2Client()
          case raw.creds.OAuth2Provider.Auth0 => new Auth0OAuth2Client()
          case raw.creds.OAuth2Provider.Twitter => new TwitterOauth2Client()
          case raw.creds.OAuth2Provider.LinkedIn => new LinkedInOauth2Client()
          case raw.creds.OAuth2Provider.Zoho => new ZohoOauth2Client()
          case raw.creds.OAuth2Provider.GoogleApi => new GoogleApiKeyOAuth2Client()
        }
