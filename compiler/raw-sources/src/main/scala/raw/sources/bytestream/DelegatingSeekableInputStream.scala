 ...
 *
 * Implementations must implement [[raw.sources.bytestream.DelegatingSeekableInputStream.getPos()]]
 * and [[raw.sources.bytestream.DelegatingSeekableInputStream.seek(long)]] and may optionally
