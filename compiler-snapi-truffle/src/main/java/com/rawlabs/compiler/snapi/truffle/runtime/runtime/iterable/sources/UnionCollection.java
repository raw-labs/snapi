...
import com.rawlabs.compiler.snapi.truffle.runtime.runtime.generator.collection.abstract_generator.compute_next.sources.UnionComputeNext;

@ExportLibrary(InteropLibrary.class)
public class UnionCollection implements TruffleObject {
  ...
  public AbstractGenerator getGenerator() {
    return new AbstractGenerator(new UnionComputeNext(inputs));
  }
