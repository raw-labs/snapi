...
import com.rawlabs.snapi.frontend.api.{HoverResponse, PackageCompletion, PackageEntryCompletion, Pos, TypeCompletion}
import com.rawlabs.snapi.compiler.tests.SnapiTestContext

class LspHoverTest extends SnapiTestContext {
