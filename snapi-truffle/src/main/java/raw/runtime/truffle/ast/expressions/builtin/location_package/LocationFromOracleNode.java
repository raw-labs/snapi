...
public class LocationFromOracleNode extends ExpressionNode {
    ...
    public LocationFromOracleNode(ExpressionNode host, ExpressionNode port, ExpressionNode db, ExpressionNode username, ExpressionNode password) {
        this.host = host;
        this.port = port;
        this.db = db;
    ...
    public Object executeGeneric(VirtualFrame frame) {
        ...
        JdbcServerLocation location = new OracleServerLocation(host, port, db, username, password, RawContext.get(this).getSettings());
