...
import com.rawlabs.snapi.frontend.snapi.extensions.builtin.FromCollectionEntry;
...
public class TruffleFromCollectionEntry extends FromCollectionEntry
    implements TruffleEntryExtension {
  @Override
  public ExpressionNode toTruffle(Type type, List<TruffleArg> args, SnapiLanguage rawLanguage) {
    return CollectionFromNodeGen.create(args.get(0).exprNode());
  }
}
