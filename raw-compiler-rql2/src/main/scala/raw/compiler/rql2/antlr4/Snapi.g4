...
// // to do ask Miguel about pure Identifiers
// fun_param: ident
//         | attr
//         | attr '=' expr
//         ;
...
//     | fun_type
//     | expr_type
// //    | package_entry_type -  skip for now if not needed
// //    | package_type - skip for now if not needed
//     ;
...
// // to do ask Miguel about the second case of this type in kiama
// fun_type: '(' fun_params? ')' '->' type;
...
//     | expr MINUS_TOKEN expr
//     | expr fun_app
//     | <assoc=right> expr '.' ident  // projection
//     | let
//     | fun_abs
//     | expr_type // to check if this works correctly with recor(a:int)
//     | if_then_else
...
// let_bind: ident '=' expr | ident ':' type '=' expr;
// let_fun: ident fun_proto;
// let_fun_rec: REC_TOKEN ident fun_proto;
