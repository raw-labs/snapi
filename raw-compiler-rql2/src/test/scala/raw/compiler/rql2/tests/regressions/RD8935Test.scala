...
trait RD8935Test extends CompilerTestContext {
  ...
  test(rql"""let lines = Collection.Transform(String.ReadLines("$vowels"), v -> v + v)
    |in Collection.Count(
    |    Collection.Unnest(
    |        Collection.Build(1,2,3),
    |        _ -> lines))""".stripMargin)(_ should evaluateTo("18L"))
  ...
  test(rql"""let lines = Collection.Filter(String.ReadLines("$vowels"), v -> true)
    |in Collection.Count(
    |    Collection.Unnest(
    |        Collection.Build(1,2,3),
    |        _ -> lines))""".stripMargin)(_ should evaluateTo("18L"))
  ...
  test(rql"""let lines = Collection.From(["a", "e", "i", "o", "u", "y"])
    |in Collection.Count(
    |    Collection.Unnest(
    |        Collection.Build(1,2,3),
    |        _ -> lines))""".stripMargin)(_ should evaluateTo("18L"))
  ...
  test(rql"""let lines = Collection.Transform(Collection.From(["a", "e", "i", "o", "u", "y"]), v -> v + v)
    |in Collection.Count(
    |    Collection.Unnest(
    |        Collection.Build(1,2,3),
    |        _ -> lines))""".stripMargin)(_ should evaluateTo("18L"))
  ...
  test(rql"""let lines = Collection.Filter(Collection.From(["a", "e", "i", "o", "u", "y"]), v -> true)
    |in Collection.Count(
    |    Collection.Unnest(
    |        Collection.Build(1,2,3),
    |        _ -> lines))""".stripMargin)(_ should evaluateTo("18L"))
  ...
  test(rql"""let lines = ["a", "e", "i", "o", "u", "y"]
    |in List.Count(
    |    List.Unnest(
    |        List.Build(1,2,3),
    |        _ -> lines))""".stripMargin)(_ should evaluateTo("18L"))
  ...
  test(rql"""let lines = List.Transform(["a", "e", "i", "o", "u", "y"], v -> v + v)
    |in List.Count(
    |    List.Unnest(
    |        List.Build(1,2,3),
    |        _ -> lines))""".stripMargin)(_ should evaluateTo("18L"))
  ...
  test(rql"""let lines = List.Filter(["a", "e", "i", "o", "u", "y"], v -> true)
    |in List.Count(
    |    List.Unnest(
    |        List.Build(1,2,3),
    |        _ -> lines))""".stripMargin)(_ should evaluateTo("18L"))
